...
# по кутках шахівниці. Підказка: для встановлення тури можна замінити значення елементу матриці за 
# допомогою індексу цього елементу
...
# заповнення його простими числами з використанням даної фуккції у ролі початкового списку на проміжку
